...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Situacao.perc'
        db.add_column(u'oportunidade_situacao', 'perc',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Oportunidade.codcrm'
        db.add_column(u'oportunidade_oportunidade', 'codcrm',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Oportunidade.obs'
        db.add_column(u'oportunidade_oportunidade', 'obs',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Situacao.perc'
        db.delete_column(u'oportunidade_situacao', 'perc')

        # Deleting field 'Oportunidade.codcrm'
        db.delete_column(u'oportunidade_oportunidade', 'codcrm')

        # Deleting field 'Oportunidade.obs'
        db.delete_column(u'oportunidade_oportunidade', 'obs')
