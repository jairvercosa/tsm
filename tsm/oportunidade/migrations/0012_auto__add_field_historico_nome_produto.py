...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Historico.nome_produto'
        db.add_column(u'oportunidade_historico', 'nome_produto',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Historico.nome_produto'
        db.delete_column(u'oportunidade_historico', 'nome_produto')
