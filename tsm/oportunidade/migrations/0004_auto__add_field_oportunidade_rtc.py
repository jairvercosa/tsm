...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oportunidade.rtc'
        db.add_column(u'oportunidade_oportunidade', 'rtc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oportunidade.rtc'
        db.delete_column(u'oportunidade_oportunidade', 'rtc')
