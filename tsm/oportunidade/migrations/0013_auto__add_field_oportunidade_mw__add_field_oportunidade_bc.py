...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oportunidade.mw'
        db.add_column(u'oportunidade_oportunidade', 'mw',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Oportunidade.bc'
        db.add_column(u'oportunidade_oportunidade', 'bc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oportunidade.mw'
        db.delete_column(u'oportunidade_oportunidade', 'mw')

        # Deleting field 'Oportunidade.bc'
        db.delete_column(u'oportunidade_oportunidade', 'bc')
