...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Oportunidade.produto'
        db.add_column(u'oportunidade_oportunidade', 'produto',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='produto_oportunidade_set', null=True, on_delete=models.PROTECT, to=orm['cliente.Produto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Oportunidade.produto'
        db.delete_column(u'oportunidade_oportunidade', 'produto_id')
