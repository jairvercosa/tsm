...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Questao.filial'
        db.alter_column(u'oportunidade_questao', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial'], null=True))

    def backwards(self, orm):

        # Changing field 'Questao.filial'
        db.alter_column(u'oportunidade_questao', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Filial']))
    ...
    models = {
        ...
        'oportunidade.oportunidade': {
            ...
            'obs': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'origem': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'origem_oportunidade_set'", 'to': "orm['oportunidade.Origem']"}),
