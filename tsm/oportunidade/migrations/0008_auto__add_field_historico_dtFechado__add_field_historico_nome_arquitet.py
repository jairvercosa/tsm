...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Historico.dtFechado'
        db.add_column(u'oportunidade_historico', 'dtFechado',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Historico.nome_arquitetos'
        db.add_column(u'oportunidade_historico', 'nome_arquitetos',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Historico.nome_gpp'
        db.add_column(u'oportunidade_historico', 'nome_gpp',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Oportunidade.gpp'
        db.add_column(u'oportunidade_oportunidade', 'gpp',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gpp_set', null=True, on_delete=models.PROTECT, to=orm['acesso.Usuario']),
                      keep_default=False)

        # Adding M2M table for field arquitetos on 'Oportunidade'
        m2m_table_name = db.shorten_name(u'oportunidade_oportunidade_arquitetos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('oportunidade', models.ForeignKey(orm['oportunidade.oportunidade'], null=False)),
            ('usuario', models.ForeignKey(orm['acesso.usuario'], null=False))
        ))
        db.create_unique(m2m_table_name, ['oportunidade_id', 'usuario_id'])


    def backwards(self, orm):
        # Deleting field 'Historico.dtFechado'
        db.delete_column(u'oportunidade_historico', 'dtFechado')

        # Deleting field 'Historico.nome_arquitetos'
        db.delete_column(u'oportunidade_historico', 'nome_arquitetos')

        # Deleting field 'Historico.nome_gpp'
        db.delete_column(u'oportunidade_historico', 'nome_gpp')

        # Deleting field 'Oportunidade.gpp'
        db.delete_column(u'oportunidade_oportunidade', 'gpp_id')

        # Removing M2M table for field arquitetos on 'Oportunidade'
        db.delete_table(db.shorten_name(u'oportunidade_oportunidade_arquitetos'))
