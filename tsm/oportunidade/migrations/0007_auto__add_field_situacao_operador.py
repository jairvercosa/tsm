...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Situacao.operador'
        db.add_column(u'oportunidade_situacao', 'operador',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Situacao.operador'
        db.delete_column(u'oportunidade_situacao', 'operador')
