...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rtc'
        db.create_table(u'oportunidade_rtc', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('criado', self.gf('django.db.models.fields.DateField')()),
            ('oportunidade', self.gf('django.db.models.fields.related.ForeignKey')(related_name='oportunidade_rtc_set', to=orm['oportunidade.Oportunidade'])),
            ('data', self.gf('django.db.models.fields.DateField')()),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('oportunidade', ['Rtc'])

        # Adding M2M table for field recursos on 'Rtc'
        m2m_table_name = db.shorten_name(u'oportunidade_rtc_recursos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('rtc', models.ForeignKey(orm['oportunidade.rtc'], null=False)),
            ('usuario', models.ForeignKey(orm['acesso.usuario'], null=False))
        ))
        db.create_unique(m2m_table_name, ['rtc_id', 'usuario_id'])


    def backwards(self, orm):
        # Deleting model 'Rtc'
        db.delete_table(u'oportunidade_rtc')

        # Removing M2M table for field recursos on 'Rtc'
        db.delete_table(db.shorten_name(u'oportunidade_rtc_recursos'))
