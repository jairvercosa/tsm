...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Funcao'
        db.create_table(u'acesso_funcao', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nome', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('acesso', ['Funcao'])

        # Adding model 'Usuario'
        db.create_table(u'acesso_usuario', (
            (u'user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('funcao', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acesso.Funcao'], null=True, blank=True)),
            ('telefone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('multEquipe', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('acesso', ['Usuario'])

        # Adding M2M table for field filiais on 'Usuario'
        m2m_table_name = db.shorten_name(u'acesso_usuario_filiais')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usuario', models.ForeignKey(orm['acesso.usuario'], null=False)),
            ('filial', models.ForeignKey(orm['core.filial'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usuario_id', 'filial_id'])


    def backwards(self, orm):
        # Deleting model 'Funcao'
        db.delete_table(u'acesso_funcao')

        # Deleting model 'Usuario'
        db.delete_table(u'acesso_usuario')

        # Removing M2M table for field filiais on 'Usuario'
        db.delete_table(db.shorten_name(u'acesso_usuario_filiais'))
