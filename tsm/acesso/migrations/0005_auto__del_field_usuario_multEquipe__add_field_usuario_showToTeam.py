...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Usuario.multEquipe'
        db.delete_column(u'acesso_usuario', 'multEquipe')

        # Adding field 'Usuario.showToTeam'
        db.add_column(u'acesso_usuario', 'showToTeam',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Usuario.multEquipe'
        db.add_column(u'acesso_usuario', 'multEquipe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Usuario.showToTeam'
        db.delete_column(u'acesso_usuario', 'showToTeam')
