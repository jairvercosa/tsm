...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field assistentes on 'Usuario'
        m2m_table_name = db.shorten_name(u'acesso_usuario_assistentes')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field assistentes on 'Usuario'
        db.delete_table(db.shorten_name(u'acesso_usuario_assistentes'))
