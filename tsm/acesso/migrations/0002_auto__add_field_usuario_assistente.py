...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'acesso_usuario', 'assistente',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assist', null=True, to=orm['acesso.Usuario']),
                      keep_default=False)
    ...
    models = {
        ...
        'acesso.usuario': {
            ...
            'assistente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assist'", 'null': 'True', 'to': "orm['acesso.Usuario']"}),
