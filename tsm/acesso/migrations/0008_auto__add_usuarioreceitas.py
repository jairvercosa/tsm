...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsuarioReceitas'
        db.create_table(u'acesso_usuarioreceitas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acesso.Usuario'], null=True)),
            ('receita', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oportunidade.Receita'], null=True)),
        ))
        db.send_create_signal('acesso', ['UsuarioReceitas'])
    ...
    def backwards(self, orm):
        # Deleting model 'UsuarioReceitas'
        db.delete_table(u'acesso_usuarioreceitas')
