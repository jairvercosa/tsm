...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segmentos on 'Usuario'
        m2m_table_name = db.shorten_name(u'acesso_usuario_segmentos')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usuario', models.ForeignKey(orm['acesso.usuario'], null=False)),
            ('segmento', models.ForeignKey(orm['cliente.segmento'], null=False))
        ))
        db.create_unique(m2m_table_name, ['usuario_id', 'segmento_id'])


    def backwards(self, orm):
        # Removing M2M table for field segmentos on 'Usuario'
        db.delete_table(db.shorten_name(u'acesso_usuario_segmentos'))
