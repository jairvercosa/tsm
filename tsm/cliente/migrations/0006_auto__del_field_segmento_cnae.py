...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Segmento.cnae'
        db.delete_column(u'cliente_segmento', 'cnae')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Segmento.cnae'
        raise RuntimeError("Cannot reverse this migration. 'Segmento.cnae' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Segmento.cnae'
        db.add_column(u'cliente_segmento', 'cnae',
    ...
    models = {
        ...
        'cliente.produto': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'segmento': ('django.db.models.fields.CharField', [], {'default': "'ERP'", 'max_length': '80'})
        },
        'cliente.segmento': {
