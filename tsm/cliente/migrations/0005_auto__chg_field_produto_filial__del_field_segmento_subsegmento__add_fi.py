...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Produto.filial'
        db.alter_column(u'cliente_produto', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial'], null=True, on_delete=models.PROTECT))
        # Deleting field 'Segmento.subsegmento'
        db.delete_column(u'cliente_segmento', 'subsegmento')

        # Adding field 'Cliente.executivo'
        db.add_column(u'cliente_cliente', 'executivo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['acesso.Usuario'], on_delete=models.PROTECT),
                      keep_default=False)


        # Changing field 'Cliente.carteira'
        db.alter_column(u'cliente_cliente', 'carteira_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Carteira'], on_delete=models.PROTECT))

        # Changing field 'Cliente.segmento'
        db.alter_column(u'cliente_cliente', 'segmento_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Segmento'], null=True, on_delete=models.PROTECT))

        # Changing field 'Cliente.filial'
        db.alter_column(u'cliente_cliente', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial'], on_delete=models.PROTECT))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Produto.filial'
        db.alter_column(u'cliente_produto', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial'], null=True))
        # Adding field 'Segmento.subsegmento'
        db.add_column(u'cliente_segmento', 'subsegmento',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Cliente.executivo'
        db.delete_column(u'cliente_cliente', 'executivo_id')


        # Changing field 'Cliente.carteira'
        db.alter_column(u'cliente_cliente', 'carteira_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Carteira']))

        # Changing field 'Cliente.segmento'
        db.alter_column(u'cliente_cliente', 'segmento_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cliente.Segmento'], null=True))

        # Changing field 'Cliente.filial'
        db.alter_column(u'cliente_cliente', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial']))

        # Changing field 'Carteira.filial'
        db.alter_column(u'cliente_carteira', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial']))
