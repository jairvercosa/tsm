...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Produto.segmento'
        db.delete_column(u'cliente_produto', 'segmento')


    def backwards(self, orm):
        # Adding field 'Produto.segmento'
        db.add_column(u'cliente_produto', 'segmento',
                      self.gf('django.db.models.fields.CharField')(default='ERP', max_length=80),
                      keep_default=False)
