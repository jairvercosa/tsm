...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SnapshotMeta'
        db.create_table(u'equipe_snapshotmeta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('equipe', ['SnapshotMeta'])


    def backwards(self, orm):
        # Deleting model 'SnapshotMeta'
        db.delete_table(u'equipe_snapshotmeta')
