...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SnapshotMetaItem.snapshot'
        db.add_column(u'equipe_snapshotmetaitem', 'snapshot',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['equipe.SnapshotMeta']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SnapshotMetaItem.snapshot'
        db.delete_column(u'equipe_snapshotmetaitem', 'snapshot_id')
    ...
    models = {
        ...
        'equipe.snapshotmetaitem': {
            ...
            'snapshot': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['equipe.SnapshotMeta']"}),
            'tipometa': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['equipe.TipoMeta']"}),
            'valor': ('django.db.models.fields.FloatField', [], {})
        },
        'equipe.tipometa': {
