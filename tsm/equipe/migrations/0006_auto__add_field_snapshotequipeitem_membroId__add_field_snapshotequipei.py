...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SnapshotEquipeItem.membroId'
        db.add_column(u'equipe_snapshotequipeitem', 'membroId',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SnapshotEquipeItem.liderId'
        db.add_column(u'equipe_snapshotequipeitem', 'liderId',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SnapshotEquipeItem.membroId'
        db.delete_column(u'equipe_snapshotequipeitem', 'membroId')

        # Deleting field 'SnapshotEquipeItem.liderId'
        db.delete_column(u'equipe_snapshotequipeitem', 'liderId')
