...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SnapshotMetaItem'
        db.create_table(u'equipe_snapshotmetaitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('criador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acesso.Usuario'], blank=True)),
            ('metaId', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('membroId', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tipometa', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['equipe.TipoMeta'])),
            ('receita', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oportunidade.Receita'])),
            ('valor', self.gf('django.db.models.fields.FloatField')()),
            ('mesVigencia', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ...
        db.send_create_signal('equipe', ['SnapshotMetaItem'])


    def backwards(self, orm):
        # Deleting model 'SnapshotMetaItem'
        db.delete_table(u'equipe_snapshotmetaitem')
    ...
    models = {
        ...
        'equipe.snapshotequipeitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'liderId': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'membroId': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'equipe.snapshotmeta': {
            'Meta': {'object_name': 'SnapshotMeta'},
            'data': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'equipe.snapshotmetaitem': {
            'Meta': {'object_name': 'SnapshotMetaItem'},
            'anoVigencia': ('django.db.models.fields.PositiveSmallIntegerField', [], {'max_length': '4'}),
            'criado': ('django.db.models.fields.DateField', [], {}),
            'criador': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['acesso.Usuario']", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_Visible': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'membroId': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'mesVigencia': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'metaId': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
