...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MembroMeta.receita'
        db.add_column(u'equipe_membrometa', 'receita',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['oportunidade.Receita']),
                      keep_default=False)


        # Changing field 'Membro.usuario'
        db.alter_column(u'equipe_membro', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['acesso.Usuario']))

        # Changing field 'TipoMeta.filial'
        db.alter_column(u'equipe_tipometa', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # Deleting field 'MembroMeta.receita'
        db.delete_column(u'equipe_membrometa', 'receita_id')


        # Changing field 'Membro.usuario'
        db.alter_column(u'equipe_membro', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['acesso.Usuario']))

        # Changing field 'TipoMeta.filial'
        db.alter_column(u'equipe_tipometa', 'filial_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Filial']))
