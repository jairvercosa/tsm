...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SnapshotEquipeItem.lider'
        db.delete_column(u'equipe_snapshotequipeitem', 'lider_id')


    def backwards(self, orm):
        # Adding field 'SnapshotEquipeItem.lider'
        db.add_column(u'equipe_snapshotequipeitem', 'lider',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='master_snapshot_equipe_set', null=True, to=orm['equipe.SnapshotEquipeItem'], blank=True),
                      keep_default=False)
